  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 640, width: "100%" }}>
        {/* Shelf unit frame */}
        <div
          className="relative rounded-lg px-10 pt-10 pb-0"
          style={{
            background:
              "linear-gradient(180deg, #c5a060 0%, #b08040 100%)",
            ...
            {NOTEBOOKS.map((nb) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ transform: `rotate(${nb.rotation}deg)`, transformOrigin: "bottom center" }}
                >
                  <div className="flex">
                    {/* Spiral binding column */}
                    <div
                      className="flex flex-col items-center justify-around py-4 pr-1"
                      style={{ gap: 0 }}
                    >
                    ...
                    >
                      ...
                      <div style={{ position: "relative", textAlign: "center", zIndex: 1 }}>
                        <div style={{ fontSize: "2.4rem", lineHeight: 1, marginBottom: 8 }}>
                          {nb.emoji}
                        </div>
                        <div
                          style={{
